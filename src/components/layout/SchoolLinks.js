...
const SchoolLinks = (props) => {
    return(
        <ul className="center">
            ...
            <li><NavLink to='/courseManagement' className="sidenav-close adminBtn">Course Management</NavLink></li>}
            {props.profile.isAdmin &&
            <li><NavLink to='/studentManagement' className="sidenav-close adminBtn">Student Management</NavLink></li>}
